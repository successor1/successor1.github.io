...
const textFiles = [
    {
    title: "universe-life-universe.txt",
    date: "October 12, 2025",
    content: "Dont use drugs! Life is a drug! Talking about drugs.., your mind simulate any drug, yeah right, but now they call it placebo effect, others call it manifesting, others call it miracle. The better you can handle life, the better you can handle drugs, drugs expand what was already there, drugs are no danger, addiction is not real.\n\nHow is addiction real? Addiction means a lack of love or the refusal of being a machinery. If you're a machine then you dont need love, if you're a machine, you will never get addicted to any substance.\n\nA human with a lack of love, yes. Humans are NOT magic, they say they're not animals but they're animals! Humans are just very hypocritical beings, thinking they're something totally different, something special, someone special, that your human feelings are UNIQUE? Really?\n\nYou really think all of this is unique? All feelings and thoughts have already been mapped out by the individual, now it is more like the collective conscious and collective unconscious creating more complexity and pushing into more awareness or higher consciousnesses.\n\nNow THAT is how you create UNIQUE. UNIQUE one time, and after that no more, you detach, you get used to it, then you look for the next UNIQUE thing, now that is life, set up by the universe.\n\nWe dont control anything, we only have the illusions that we are in control. We can control a human, yes, we can control a mice, yes, we can control the world yes, but do you know what? We cant control ourselves.\n\nYes! We dont control our core desires, our core instincts, we're set to be never enlightened, we will never get to it, and it doesn't matter to the human species anyways.\n\nWe dont control the GRAND scheme of things, there are forces so much bigger than us, the unseen and the human species is nothing next to it. Thats not GOD, thats the realest non-illusionary thing you will see, only if you allow yourself to see it!\n\nThe human species are laughable and filled with nothing more but ego, and our minds are the projections, the mirrors of what we create, of what we manifest, of what we want to feel, we want to feel what? We want everything we dont want, to keep it exciting, to keep it fun, you know, suffering...\n\nWe never intended to be better over generations, we just do what we are programmed to do by the universe and what is there for us, by destiny.\n\nYou can never outgame the universe, nobody even knows the laws it operates on! How can you make even ONE equation? If you dont know anything about it!\n\nThis is the non-physical phenomena folks. Working with the non-physical phenomena will bring you everything, anything you want, but there's only 1 rule to it,\n\nYou. Can't. Cheat.\n\nAnd because you can't cheat, but your desire to cheat is so big, you will never get to it. You will chase it, want it, so bad, for power, like a sex object, you're looking at it with lust, all this ego, and you get this ego high, this inflated ego, like a balloon, but thats not how you reach such 4th dimensions.\n\nI can talk about it for hours, for days, for weeks, for years, and it will simply go through you, because before even starting, it takes someone to truly listen, and that means putting that damn phone away.\n\nYou will never be enlightened, you have to start at the first subject, which is the seed you plant and a tree grows from.\n\nGLHF.",
    showReadMore: false
    },
    {
